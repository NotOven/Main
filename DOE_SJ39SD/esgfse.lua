...
if Options.Reanim_Type == "Humanoid" then -- Humanoid
	local OnCharacterAdded = function(Character)
		...
		Character:WaitForChild('Head').CFrame = Clone.Head.CFrame
...
elseif Options.Reanim_Type == "Hat" then
	...
	if Options.BoomBox_Enabled and Options.Reanim_Type == "Hat" then
	...
	for i,v in pairs(Character.Torso:GetChildren()) do
		if v:IsA("Motor6D") and v.Name ~= "Neck" then
		    if v.Part1 then v.Part1:Destroy() end
			v:Destroy()
		end
	end
