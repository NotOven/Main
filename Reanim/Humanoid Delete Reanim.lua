...
wait(game.Players.RespawnTime - 0.15)
CamCFrame,CamFocus = workspace.CurrentCamera.CFrame, workspace.CurrentCamera.Focus
pos = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
	game.Players.LocalPlayer.CharacterAdded:wait()
	game.Players.LocalPlayer.Character:WaitForChild('ForceField')
	game.Players.LocalPlayer.Character.ForceField: Destroy()
	game.Players.LocalPlayer.Character:WaitForChild('HumanoidRootPart')
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = pos
	wait()
	workspace.CurrentCamera.CFrame = CamCFrame
	workspace.CurrentCamera.Focus = CamFocus
end
